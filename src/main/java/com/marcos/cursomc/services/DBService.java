...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@teste.com", "363778912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana@teste.com", "39646457029", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("2324234324", "23123123123"));
		...
		p1.getItemPedidos().addAll(Arrays.asList(item1));
		p2.getItemPedidos().addAll(Arrays.asList(item3));
		p3.getItemPedidos().addAll(Arrays.asList(item2));
